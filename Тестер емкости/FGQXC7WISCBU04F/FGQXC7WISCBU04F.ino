...
void draw(void) {
   ...
   u8g.drawStr(0, 10, "Volt: ");   // put string of display at position X, Y
   u8g.drawStr(0, 21, "Curr: ");
   u8g.drawStr(0, 32, "mAh: ");
   ...
   */
   ...
   u8g.print(" V"); 
   u8g.setPrintPos(58,21);        // set position
   u8g.print( mA,0);  // display current in mA
   u8g.print(" mA"); 
   u8g.setPrintPos(58, 32);        // set position
